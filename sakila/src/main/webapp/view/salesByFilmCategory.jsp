...
<%
	...
	//dao에 생성된 메소드 호출
	List<SalesByFilmCategory> list = salesByFilmCategoryDao.selecByFilmList(beginRow, rowPerPage); 
	
	//마지막 페이지
	int lastPage = 0;
	int totalRow = salesByFilmCategoryDao.totalRow(); //dao에 생성된 메소드 호출
...
<ul class="nav justify-content-end bg-dark ">
	...
	<p><h1 class="text-dark">SalesByFilmCategory</h1></p>
