...
<%
	...
	//dao에 생성된 메소드 호출
	List<FilmList> list = filmListDao.selectFilmList(beginRow, rowPerPage); 
	
	//마지막 페이지
	int lastPage = 0;
	int totalRow = filmListDao.totalRow(); //dao에 생성된 메소드 호출
...
<ul class="nav justify-content-end bg-dark ">
	...
	<p><h1 class="text-dark">Film List</h1></p>
	...
	<div class="btn-group ">
		...
		<%
		 ...
		 %>
		 	<a href="<%=request.getContextPath()%>/view/filmList.jsp?currentPage=<%=currentPage+1%>" class="btn btn-outline-info">다음</a>
		 <% 
		 	}
		%>
	</div>
